...
const Register = () => {
  ...
  const postOrganiserData=async (e)=>{
          e.preventDefault();
          const{name,email,phone,pass,Cpass}=user;
  ...
  <button type="submit" className="btn btn-primary" onClick={postUserData}>SubmitUSER</button>
  <button type="submit" className="btn btn-primary mx-4" onClick={postOrganiserData}>Submit ORGANISER</button>
</form>
</div>
